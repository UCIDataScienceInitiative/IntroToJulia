...
define i64 @"jlsys\_*\_56568"(i64, i64) \#0 !dbg !5 \{
top:
  \%2 = mul i64 \%1, \%0
  ret i64 \%2
\}
...
\end{Verbatim}
    ...
    Make x a float by adding a zero decimal (e.g. 2.0\^{}-n instead of 2\^{}-n), or write 1/x\^{}n, float(x)\^{}-n, or (x//1)\^{}-n.
        ...
        Stacktrace:
         ...
         [1] power\_by\_squaring(::Int64, ::Int64) at ./intfuncs.jl:173

         [2] literal\_pow(::Base.\#\^{}, ::Int64, ::Type\{Val\{-5\}\}) at ./intfuncs.jl:208
...
\texttt{Vector\{Any\}}. For example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{n}{a} \PY{o}{=} \PY{k+kt}{Vector}\PY{p}{\PYZob{}}\PY{k+kt}{Any}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}
...
what it sounds like. For example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{a} \PY{o}{=} \PY{k+kt}{Vector}\PY{p}{\PYZob{}}\PY{k+kt}{Union}\PY{p}{\PYZob{}}\PY{k+kt}{Float64}\PY{p}{,}\PY{k+kt}{Int}\PY{p}{\PYZcb{}}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}
         \PY{n}{a}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{=} \PY{l+m+mf}{1.0}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}14}]:} 3-element Array\{Union\{Float64, Int64\},1\}:
          1.0 
          3   
          0.25
\end{Verbatim}
...
Body:
  begin 
      return \$(Expr(:invoke, MethodInstance for power\_by\_squaring(::Int64, ::Int64), :(Base.power\_by\_squaring), :(x), :(p)))
  end::Int64
...
typed. What about in our \texttt{expo}?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n+nd}{@code\PYZus{}warntype} \PY{n}{expo}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
\end{Verbatim}
...
Variables:
  ...
  x@\_2::Int64
  y::Int64
  x@\_4\textcolor{ansi-red-intense}{\textbf{::Union\{Float64, Int64\}}}
  \#temp\#::Float64

Body:
  begin 
      x@\_4\textcolor{ansi-red-intense}{\textbf{::Union\{Float64, Int64\}}} = x@\_2::Int64
      unless (Base.slt\_int)(0, y::Int64)::Bool goto 5 \# line 3:
      return \$(Expr(:invoke, MethodInstance for power\_by\_squaring(::Int64, ::Int64), :(Base.power\_by\_squaring), :(x@\_4::Int64), :(y)))
      5:  \# line 5:
      x@\_4\textcolor{ansi-red-intense}{\textbf{::Union\{Float64, Int64\}}} = (Base.sitofp)(Float64, x@\_4::Int64)::Float64 \# line 6:
      \$(Expr(:inbounds, false))
      ...
      SSAValue(4) = (Base.add\_float)(x@\_4::Float64, SSAValue(0))::Float64
      \# meta: location math.jl nan\_dom\_err 300
      unless (Base.and\_int)((Base.ne\_float)(SSAValue(3), SSAValue(3))::Bool, (Base.not\_int)((Base.ne\_float)(SSAValue(4), SSAValue(4))::Bool)::Bool)::Bool goto 19
      \#temp\#::Float64 = (Base.Math.throw)(\$(QuoteNode(DomainError())))\textcolor{ansi-red-intense}{\textbf{::Union\{\}}}
      goto 21
      19: 
      ...
      \$(Expr(:inbounds, :pop))
      return \#temp\#::Float64
  end\textcolor{ansi-red-intense}{\textbf{::Union\{Float64, Int64\}}}
...
function like:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{k}{function} \PY{n}{foo}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{,}\PY{n}{N}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{n}{array}\PY{o}{::}\PY{k+kt}{Array}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{,}\PY{n}{N}\PY{p}{\PYZcb{}}\PY{p}{)}
...
on elements:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{k}{function} \PY{n}{inner\PYZus{}foo}\PY{p}{\PYZob{}}\PY{n}{T}\PY{o}{\PYZlt{}:}\PY{k+kt}{Number}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{n}{val}\PY{o}{::}\PY{n}{T}\PY{p}{)}
           \PY{c}{\PYZsh{} Do algorithm X on val}
         \PY{k}{end}
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{k}{function} \PY{n}{foo2}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{,}\PY{n}{N}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{n}{array}\PY{o}{::}\PY{k+kt}{Array}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{,}\PY{n}{N}\PY{p}{\PYZcb{}}\PY{p}{)}
           \PY{k}{for} \PY{n}{i} \PY{k+kp}{in} \PY{n}{eachindex}\PY{p}{(}\PY{n}{array}\PY{p}{)}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}19}]:} foo2 (generic function with 1 method)
\end{Verbatim}
...
function.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{k}{function} \PY{n}{test}\PY{p}{(}\PY{n}{x}\PY{p}{)}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}20}]:} test (generic function with 1 method)
\end{Verbatim}
...
highest scope (and thus effectively the global scope):
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{a} \PY{o}{=} \PY{l+m+mi}{3}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}21}]:} 3.0
\end{Verbatim}
...
to specify variables as constant:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{k+kd}{const} \PY{n}{a\PYZus{}cons} \PY{o}{=} \PY{l+m+mi}{3}
         \PY{k}{function} \PY{n}{badidea}\PY{p}{(}\PY{p}{)}
             \PY{n}{a\PYZus{}cons} \PY{o}{+} \PY{l+m+mi}{2}
         \PY{k}{end}
         \PY{n}{a\PYZus{}cons} \PY{o}{=} \PY{l+m+mi}{4} \PY{c}{\PYZsh{} Works}
