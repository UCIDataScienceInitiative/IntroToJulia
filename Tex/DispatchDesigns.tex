...
; Function my\_square
; Location: In[1]:1
define i64 @julia\_my\_square\_36334(i64) \{
top:
...
; Function my\_square
; Location: In[1]:1
define double @julia\_my\_square\_36349(double) \{
top:
; Function literal\_pow; \{
; Location: intfuncs.jl:243
; Function *; \{
...
; Location: In[4]:1
define i64 @julia\_my\_restricted\_square\_36359(i64) \{
top:
; Function literal\_pow; \{
; Location: intfuncs.jl:243
; Function *; \{
...
can see this by looking at its fields:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{fieldnames}\PY{p}{(}\PY{n}{typeof}\PY{p}{(}\PY{n}{a}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} (:start, :stop)
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
  0.082343 seconds (29 allocations: 76.297 MiB, 13.04\% gc time)

    \end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:} 10000000-element Array\{Int64,1\}:
                 1
                 2
                 3
                 4
...
like an identity matrix without forming an identity matrix.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{using} \PY{n}{LinearAlgebra}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{x} \PY{o}{=} \PY{n}{Teacher}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{R}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{d}\PY{l+s}{y}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{l+m+mi}{11}\PY{p}{)}
...
music genre types:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{k}{abstract} \PY{k}{type} \PY{n}{MusicGenres} \PY{k}{end}
...
can have traits like:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{favorite\PYZus{}genre}\PY{p}{(}\PY{n}{x}\PY{o}{::}\PY{n}{AbstractPerson}\PY{p}{)} \PY{o}{=} \PY{n}{ClassicRock}\PY{p}{(}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}22}]:} favorite\_genre (generic function with 3 methods)
\end{Verbatim}
...
allows you to dispatch on a trait \texttt{IsNice} like:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{using} \PY{n}{SimpleTraits}
        \PY{n+nd}{@traitfn} \PY{n}{ft}\PY{p}{(}\PY{n}{x}\PY{o}{::}\PY{o}{::}\PY{n}{IsNice}\PY{p}{)} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{V}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{y}\PY{l+s}{ }\PY{l+s}{n}\PY{l+s}{i}\PY{l+s}{c}\PY{l+s}{e}\PY{l+s}{!}\PY{l+s}{\PYZdq{}}
...
can extend \texttt{MyType} by making it a field in another type:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{n}{mutable} \PY{n}{struct} \PY{n}{MyType2}
...
macro.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{k}{macro} \PY{n}{def}\PY{p}{(}\PY{n}{name}\PY{p}{,} \PY{n}{definition}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}1}]:} @def (macro with 1 method)
\end{Verbatim}
...
example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{n+nd}{@def} \PY{n}{give\PYZus{}it\PYZus{}a\PYZus{}name} \PY{k}{begin}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}2}]:} @give\_it\_a\_name (macro with 1 method)
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n+nd}{@give\PYZus{}it\PYZus{}a\PYZus{}name}
\end{Verbatim}
...
Optim.jl's solvers could be put into an \texttt{@def}:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n+nd}{@def} \PY{n}{add\PYZus{}generic\PYZus{}fields} \PY{k}{begin}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:} @add\_generic\_fields (macro with 1 method)
\end{Verbatim}
            
    and those fields can be copied around with

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{mutable} \PY{n}{struct} \PY{n}{LBFGSState}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
...
types inherit the fields (note: it is v0.6 only and needs an update!):
