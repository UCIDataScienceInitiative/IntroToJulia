...
behavior. For example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{AbstractPerson}
         \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{AbstractStudent} \PY{o}{\PYZlt{}:} \PY{n}{AbstractPerson}
         \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{AbstractTeacher} \PY{o}{\PYZlt{}:} \PY{n}{AbstractPerson}
         
         \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{Person} \PY{o}{\PYZlt{}:} \PY{n}{AbstractPerson}
           \PY{n}{name}\PY{p}{:}\PY{p}{:}\PY{n}{String}    
         \PY{k}{end}
         
         \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{Student} \PY{o}{\PYZlt{}:} \PY{n}{AbstractStudent}
           \PY{n}{name}\PY{p}{:}\PY{p}{:}\PY{n}{String}  
           \PY{n}{grade}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int}
           \PY{n}{hobby}\PY{p}{:}\PY{p}{:}\PY{n}{String}
         \PY{k}{end}
         
         \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{MusicStudent} \PY{o}{\PYZlt{}:} \PY{n}{AbstractStudent}
           \PY{n}{grade}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int}
         \PY{k}{end}
         
         \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{Teacher} \PY{o}{\PYZlt{}:} \PY{n}{AbstractTeacher}
           \PY{n}{name}\PY{p}{:}\PY{p}{:}\PY{n}{String}
           \PY{n}{grade}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int}
         \PY{k}{end}
\end{Verbatim}
...
music genre types:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{MusicGenres}
         \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{RockGenre} \PY{o}{\PYZlt{}:} \PY{n}{MusicGenres}
         \PY{k}{immutable} \PY{n}{ClassicRock} \PY{o}{\PYZlt{}:} \PY{n}{RockGenre} \PY{k}{end}
         \PY{k}{immutable} \PY{n}{AltRock} \PY{o}{\PYZlt{}:} \PY{n}{RockGenre} \PY{k}{end}
         \PY{k}{immutable} \PY{n}{Classical} \PY{o}{\PYZlt{}:} \PY{n}{MusicGenres} \PY{k}{end}
\end{Verbatim}
...
can extend \texttt{MyType} by making it a field in another type:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{MyType2}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{LBFGSState}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} The abstract type}
        \PY{p}{@}\PY{n}{base} \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{AbstractFoo}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
            \PY{n}{a}
        ...
        \PY{p}{@}\PY{n}{extend} \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{Foo} \PY{o}{\PYZlt{}:} \PY{n}{AbstractFoo}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{type}\PY{n+nc}{ }\PY{n+nc}{Foo}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}} \PY{o}{\PYZlt{}:} \PY{n}{AbstractFoo}
            \PY{n}{a}
            \PY{n}{b}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int}
            \PY{n}{c}\PY{p}{:}\PY{p}{:}\PY{n}{T}
            \PY{n}{d}\PY{p}{:}\PY{p}{:}\PY{n}{Vector}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
