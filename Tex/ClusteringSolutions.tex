...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{using} \PY{n}{RDatasets}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}3}]:} 150×5 DataFrame
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{k}{using} \PY{n}{Clustering}
         \PY{n}{features} \PY{o}{=} \PY{n}{copy}\PY{p}{(}\PY{n}{convert}\PY{p}{(}\PY{k+kt}{Array}\PY{p}{,}\PY{n}{iris}\PY{p}{[}\PY{o}{:}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{o}{\PYZsq{}}\PY{p}{)} \PY{c}{\PYZsh{} The copy is to make the adjoint non\PYZhy{}lazy!}
         \PY{n}{result} \PY{o}{=} \PY{n}{kmeans}\PY{p}{(} \PY{n}{features}\PY{p}{,} \PY{l+m+mi}{3} \PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}13}]:} KmeansResult\{Float64\}([6.81 5.006 5.89667; 5.7075 1.462 4.37167; 2.075 0.246 1.41], [2, 2, 2, 2, 2, 2, 2, 2, 2, 2  …  1, 1, 3, 1, 1, 1, 1, 1, 1, 3], [0.014796, 0.017196, 0.121996, 0.168396, 0.005996, 0.235596, 0.171596, 0.003596, 0.373196, 0.033996  …  0.129281, 0.427781, 0.779914, 0.0877813, 0.192781, 0.320281, 0.791281, 0.359281, 0.517281, 0.682581], [40, 50, 60], [40.0, 50.0, 60.0], 63.484116666666445, 12, true)
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{features}\PY{o}{\PYZsq{}}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}15}]:} 150×3 LinearAlgebra.Adjoint\{Float64,Array\{Float64,2\}\}:
          5.1  1.4  0.2
          4.9  1.4  0.2
          4.7  1.3  0.2
          4.6  1.5  0.2
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{copy}\PY{p}{(}\PY{n}{features}\PY{o}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}16}]:} 150×3 Array\{Float64,2\}:
          5.1  1.4  0.2
          4.9  1.4  0.2
          4.7  1.3  0.2
          4.6  1.5  0.2
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{k}{using} \PY{n}{Plots}\PY{p}{;} \PY{n}{gr}\PY{p}{(}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{ClusteringSolutions_files/ClusteringSolutions_5_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{for} \PY{p}{(}\PY{n}{cluster\PYZus{}ii}\PY{p}{,} \PY{n}{examplar\PYZus{}ind}\PY{p}{)} \PY{k+kp}{in} \PY{n}{enumerate}\PY{p}{(}\PY{n}{aprop}\PY{o}{.}\PY{n}{exemplars}\PY{p}{)}
            ...
            \PY{n}{cluster\PYZus{}member\PYZus{}inds} \PY{o}{=} \PY{n}{find}\PY{p}{(}\PY{n}{assignments}\PY{p}{(}\PY{n}{aprop}\PY{p}{)}\PY{o}{.==}\PY{n}{cluster\PYZus{}ii}\PY{p}{)}
